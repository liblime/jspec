...
(function(){JSpec={version:'1.0.1',main:this,suites:[],matchers:{},stats:{specs:0,assertions:0,failures:0,passes:0},options:{profile:false},defaultContext:{sandbox:function(name){sandbox=document.createElement('div')
...
return length>=range.shift()&&length<=range.pop()}},have_property:{match:function(actual,property,value){if(actual[property]==null||typeof actual[property]=='function')return false
