...
(function(){JSpec={version:'1.1.2',main:this,suites:[],matchers:{},stats:{specs:0,assertions:0,failures:0,passes:0},options:{profile:false},defaultContext:{sandbox:function(name){sandbox=document.createElement('div')
...
error('cannot load '+file)},exec:function(file){eval(this.preprocess(this.load(file)))
return this}}
map=JSpec.map
any=JSpec.any
last=JSpec.last
