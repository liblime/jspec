...
catch(e){throw'JSpec depends on '+dependency+' '+(message||'')}},throw:function(error){throw'jspec(): '+error},eval:function(input){return this.parse(input)},load:function(file){if('XMLHttpRequest'in this.main){var request=new XMLHttpRequest
