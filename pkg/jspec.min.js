...
(function(){var JSpec={version:'0.6.3',main:this,suites:{},matchers:{},stats:{specs:0,assertions:0,failures:0,passes:0},defaultContext:{sandbox:function(name){var sandbox=document.createElement('div')
...
this.requiresImplementation=function(){return this.assertions.length==0}},hash:function(object){var buff=''
each(object,function(key,value){if(value.constructor==Array||value.constructor==Object)buff+=hash(value)
else buff+=key.toString()+value.toString()})
return buff},print:function(object){if(object==undefined)return''
...
return JSpec},evalBody:function(body,errorMessage){try{var runner=function(){eval(JSpec.preProcessBody(body))}
...
return this},run:function(){each(this.suites,function(suite){this.runSuite(suite)})
