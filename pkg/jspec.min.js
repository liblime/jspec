...
catch(e){this.throw(errorMessage+e)}},preProcessBody:function(body){body=body.replace(/\.should_(\w+)(?: |$)(.*)$/gm,'.should_$1($2)')
...
catch(e){this.throw('depends on '+dependency+' '+(message||''))}},throw:function(error){throw'jspec: '+error},eval:function(input){return this.parse(input)},load:function(file){if('XMLHttpRequest'in this.main){var request=new XMLHttpRequest
