...
(function($){
  ...
  JSpec.addMatchers({
    ...
    be_visible    : "jQuery(actual).css('display') != 'none' && jQuery(actual).css('visibility') != 'hidden'",
    be_hidden     : "jQuery(actual).css('display') == 'none' || jQuery(actual).css('visibility') == 'hidden'",
  ...
  $.each(['checkbox', 'radio', 'file', 'password', 'submit', 'image', 'text', 'reset', 'button'], function(i, type){
