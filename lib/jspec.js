    ...
    formatters : {
       ...
       */
       ...
       Terminal : function(results, options) {
         puts(" Passes: " + color(results.stats.passes, 'green') + 
              " Failures: " + color(results.stats.failures, 'red') + "\n")

         renderSuite = function(suite) {
           if (suite.ran && suite.hasSpecs()) {
             ...
             results.each(suite.specs, function(spec){
               ...
               if (spec.requiresImplementation())
                 ...
                 puts(color('  ' + spec.description + '. ', 'red') + spec.failure().message + assertionsGraph)
             })
             puts('')
           }          
         }
