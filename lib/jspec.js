...
(function(){
  ...
  var JSpec = {
    ...
    ProxyAssertion : function(object, method) {
      this[method] = function(){
        args = []
        // TODO: refactor ... this is done a few times make a util
        for (i = 0; i < arguments.length; i++) args.push(arguments[i])
        result = object[method].apply(args)
        this.calls.push({ args : args, result : result })
        return result
      }
      ...
      extend(this, {
        ...
        exec : function() {
          if (typeof object[method] != 'function')
            ...
            this.message = object.toString() + ' was called ' + this.calls.length + ' times, expected ' + this.times
          else {
            // TODO: iterate args ...
          }
  ...
  addMatchers({
    ...
    receive : function(actual, method) {
      proxy = new JSpec.ProxyAssertion(actual, method)
      JSpec.currentSpec.assertions.push(proxy.exec())
      proxy.passed ? JSpec.stats.passes++ : JSpec.stats.failures++
      return proxy
    },
