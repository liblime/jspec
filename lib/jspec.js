...
(function(){
  ...
  var JSpec = {
    ...
    findSuiteIn : function(description, suites) {
      // TODO: fix ... / add to readme
      return find(suites, function(suite){
        return suite.name == description ||
                 suite.description == description ? suite:
                     JSpec.findSuiteIn(description, suite.suites)
      })
    },
    ...
    shareBehaviorsOf : function(description) {
      suite = this.findSuiteIn(description, this.currentSuite.suite.suites)
      if (suite) this.copySpecs(suite, this.currentSuite)
