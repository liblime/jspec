    ...
    formatters : {
       ...
       */
       ...
       Terminal : function(results, options) {
         puts(color('foo', 'green'))
         return 
         puts("\n\u001B[31mPasses\u001B[0m: " + results.stats.passes + " Failures: " + results.stats.failures + "\n")
           ...
           if (suite.ran) {
             ...
             results.each(suite.specs, function(spec){
               ...
               if (spec.requiresImplementation())
                 ...
                 puts(assertionCount + ' ' + spec.description)
               else 
                 puts(assertionCount + ' ' + spec.description + ', ' + spec.failure().message)
             })
             puts("\n")
           }          
         }
