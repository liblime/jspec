     ...
     inject : function(object, initial, callback) {
       each(object, function(key, value){
         initial = callback.length == 2 ?
           callback.call(this, initial, value):
             callback.call(this, initial, key, value) || initial
       })
       return initial
     },
    ...
    any : function(object, callback) {
      return inject(object, null, function(state, key, value){
        ...
        return callback.length == 1 ?
          callback.call(this, value) ? value : state :
            callback.call(this, key, value) ? value : state
      })
    },
