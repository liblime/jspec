...
(function(){
  ...
  var JSpec = {
    ...
    ProxyAssertion : function(object, method, times) {
      ...
      extend(this, {
        ...
        failingResult : function() {
          // TODO: create find() util move to any() and alias any
          return this.anyResultsFail().result
        },
        
        anyArgsFail : function() {
          return any(this.calls, function(call){
            return any(self.args, function(i, arg){
        ...
        failingArgs : function() {
          // TODO: fix / renamed ... convetions keep shifting expectedArgs etc
        ...
        exec : function() {
          ...
          if (this.args.length && this.anyArgsFail())
    ...
    each : function(object, callback) {
      // TODO: remove JSpec context ... so self does not need to be used
    ...
    any : function(object, callback) {
      return inject(object, null, function(state, key, value){
        ...
        return callback.length == 1 ?
          callback.call(JSpec, value) ? value : state :
            callback.call(JSpec, key, value) ? value : state
      })
    },
