...
(function(){
  ...
  JSpec = {
    ...
    Matcher : function (name, matcher, actual, expected, negate) {
      ...
      this.message = ''
      this.passed = false
      matcher = JSpec.normalizeMatcher(matcher)
    ...
    Suite : function(description, body) {
      ...
      this.it = function(description, body) {
      ...
      this.describe = function(description, body) {
    ...
    /**
     * Normalize a matcher, allowing the following conversions until
    ...
    normalizeMatcher : function(matcher) {
      switch (matcher.constructor) {
        case String:
          if (captures = matcher.match(/^alias (\w+)/)) matcher = JSpec.matchers[captures[1]]
    ...
    runSpec : function(spec) {
      ...
      catch (e) { spec.assertions.push({ passed : false, message : e }) }
