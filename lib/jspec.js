...
(function(){
  ...
  JSpec = {
     ...
     * considered non-mutative. This function passes the arg
    ...
    hookSequence : function(name, arg) {
    ...
    preprocess : function(input) {
      input = hookSequence('preprocessing', input)
      return input.
  ...
  var main = this
  var find = JSpec.any
  var utils = 'haveStopped stub hookSequence hook destub map any last fail range each option inject select error escape \
