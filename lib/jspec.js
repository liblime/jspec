    ...
    throw_error : { match : function(actual, expected, message) {
      try { actual() }
        ...
        var assert = function(arg) {
          switch (arg.constructor) {
            case RegExp   : return arg.test(self.e)
            case Function : return self.e instanceof arg
            case String   : return arg == e.toString()
          }
        }
        return expected == undefined ? true :
                 message ? assert(expected) && assert(message) :
                   assert(expected)
      }
    }, message : function(actual, expected, negate) {
      // TODO: refactor with negate earlier?
      // TODO: Array.prototype.slice.call()
      var message_for = function(i) {
        ...
        switch (expected[i].constructor) {
          ...
          case Function : return 'instance of ' + expected[i].name
