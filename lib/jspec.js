  ...
  JSpec = {
     ...
     */
		findLocalSharedBehavior : function(description){
			...
			while( currentSuite ){
				sharedSuite = find(currentSuite.suites, JSpec.suiteDescriptionPredicate(description))
     ...
     */
		...
		{
			return function(suite){return suite.name==description || suite.description == description}
		},
