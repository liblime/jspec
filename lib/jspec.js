  ...
  JSpec = {
      ...
      extend(this, {
        ...
        runDeferredAssertions : function() {
          each(this.assertions, function(assertion){
            if (assertion.defer) assertion.run().report(), hook('after_assertion', assertion)
          })
        },
    ...
    expect : function(actual) {
      assert = function(matcher, args, negate) {
        ...
        hook('before_assertion', assertion)
        if (matcher.defer) assertion.run()
        else JSpec.currentSpec.assertions.push(assertion.run().report()), hook('after_assertion', assertion)
     ...
     */
     ...
     stub : function(object, method) {
       return {
         and_return : function(result) {
           hook('stubbing_method', object, method, result)
