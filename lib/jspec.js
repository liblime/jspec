  ...
  JSpec = {
    ...
    Matcher : function (name, body) {
      ...
      extend(this, {
        ...
        // TODO: assertion = this.matchers[name].exec(actual, expected, negate)
        exec : function() {
      ...
      generateMessage = function(actual, expected, negate) {
    ...
    match : function(actual, negate, name, expected) {
      ...
      assertion = this.matchers[name].exec(actual, expected, negate)
      this.currentSpec.assertions.push(assertion)
    ...
    addMatcher : function(name, body) {
      body = this.normalizeMatcherMessage(this.normalizeMatcherBody(body))
      this.matchers[name] = new JSpec.Matcher(name, body)
      return this
    },
    ...
    runSpec : function(spec) {
      ...
      try { this.evalBody(spec.body) }
        ...
        spec.assertions.push({ passed : false, message : e })
